...
file1_path = r'Data Tab.xlsx'
file2_path = r'Mail Plan.xlsx'
...
def normalize_date(val):
 ...
 val_str = str(val).strip() # Fix for 7312025-like format
 ...
 return val # Return as-is if no date parsing works
